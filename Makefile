...
#    Updated: 2025/02/17 13:49:55 by aahlaqqa         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
mendatory/check_borders.c mendatory/ft_strcpy.c Libft/ft_memset.c \
...
mendatory/raycasting.c mendatory/cube_movements.c
OBJECTS= $(SOURCES:.c=.o)
